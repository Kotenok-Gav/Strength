...
# ----------------------------------------------------------------
        ...
        if (bd.m_dy_1 > 0):
            ...
            file.write("CONM2   {: <8.1f}{: <8.1f}        {: <8.2f}\n".format(
                n_dy + 7000, n_dy, bd.m_dy_1))
        if (bd.m_cy > 0):
            n_cy = ((bd.X_cy / k) + 1)
            file.write("CONM2   {: <8.1f}{: <8.1f}        {: <8.2f}\n".format(
                n_cy + 7000, n_cy, bd.m_cy))
        if (bd.m_gch > 0):
            n_gch = ((bd.X_gch / k) + 1)
            file.write("CONM2   {: <8.1f}{: <8.1f}        {: <8.2f}\n".format(
                n_gch + 7000, n_gch, bd.m_gch))
        file.write("\n")
        ...
        if  tip_zakr_3 == None:
            ...
            file.write("SPC     10      {: <8.1f}tip_zakr_1\n".format(L_kon_zakr_1 * 10 + 100001))
            file.write("SPC     10      {: <8.1f}tip_zakr_2\n".format(L_kon_zakr_2 * 10 + 100001))
            file.write("SPC     10      {: <8.1f}tip_zakr_3\n".format(L_kon_zakr_3 * 10 + 100001))
            file.write("SPC     10      {: <8.1f}tip_zakr_4\n".format(L_kon_zakr_4 * 10 + 100001))
        ...
        if (bd.P12 < 10000000 and bd.P12 > 1000000 or bd.P12 == 1000000):
            ...
            file.write("TABLED1 411\n        0.0     0.0     1.0     0.0     {: <8.3f}{: <8.5f}{: <8.3f}{: <8.5f}\n".format(
                bd.t_p1, bd.P1, bd.t_p2, bd.P2))
            file.write("        {: <8.3f}{: <8.4f}{: <8.3f}{: <8.4f}{: <8.3f}{: <8.4f}{: <8.3f}{: <8.4f}\n".format(
                bd.t_p3, bd.P3, bd.t_p4, bd.P4, bd.t_p5, bd.P5, bd.t_p6, bd.P6))
            file.write("        {: <8.3f}{: <8.4f}{: <8.3f}{: <8.4f}{: <8.3f}{: <8.4f}{: <8.3f}{: <8.4f}\n".format(
                bd.t_p7, bd.P7, bd.t_p8, bd.P8, bd.t_p9, bd.P9, bd.t_p10, bd.P10))
            file.write("        {: <8.3f}{: <8.4f}{: <8.3f}{: <8.4f}{: <8.3f}{: <8.4f}ENDT\n".format(
                bd.t_p11, bd.P11, bd.t_p12, bd.P12, bd.t_p13, bd.P13))
            ...
            file.write("TABLED1 411\n        0.0     0.0     1.0     0.0     {: <8.3f}{: <8.5f}{: <8.3f}{: <8.5f}\n".format(
                bd.t_p1, bd.P1 / 1000, bd.t_p2, bd.P2 / 1000))
            file.write("        {: <8.3f}{: <8.4f}{: <8.3f}{: <8.4f}{: <8.3f}{: <8.4f}{: <8.3f}{: <8.4f}\n".format(
                bd.t_p3, bd.P3 / 1000, bd.t_p4, bd.P4 / 1000, bd.t_p5, bd.P5 / 1000, bd.t_p6, bd.P6 / 1000))
            file.write("        {: <8.3f}{: <8.4f}{: <8.3f}{: <8.4f}{: <8.3f}{: <8.4f}{: <8.3f}{: <8.4f}\n".format(
                bd.t_p7, bd.P7 / 1000, bd.t_p8, bd.P8 / 1000, bd.t_p9, bd.P9 / 1000, bd.t_p10, bd.P10 / 1000))
            file.write("        {: <8.3f}{: <8.4f}{: <8.3f}{: <8.4f}{: <8.3f}{: <8.4f}ENDT\n".format(
                bd.t_p11, bd.P11 / 1000, bd.t_p12, bd.P12 / 1000, bd.t_p13, bd.P13 / 1000))
        ...
        file.write("MAT1    2       {: <2.1f}+10          {: <8.2f}{: <8.3f}".format(
        ...
        file.write("GRID    9000            0.0     {: <8.3f}0.0".format(
            (bd.d0 / 2) + Decimal('0.1')))
        file.write("\n\n")
